            ...
            <div className={styles.footerContent}>
              ...
              <div className={styles.gridSection}>
                ...
                <div className={styles.flexColumn}>
                  ...
                  <ul className={styles.list}>
                    <li className={styles.listItem}>Why Rise</li>
                    <li className={styles.listItem}>Rise for Business</li>
                    <li className={styles.listItem}>Investment club</li>
                    <li className={styles.listItem}>Developer</li>
              ...
              <div className={styles.gridSection}>
                <div className={styles.flexColumn}>
                  <h6 className={styles.heading}>Legal</h6>
                  <ul className={styles.list}>
                ...
                <div className={styles.flexColumn}>
                  ...
                  <ul className={styles.list}>
                    <li className={styles.listItem}>+234 01 888 3519</li>
                    <li className={styles.listItem}>+234 01 888 3519</li>
                    <li className={styles.listItem}>hello@risevest.com</li>
                  </ul>
                </div>
              </div>
